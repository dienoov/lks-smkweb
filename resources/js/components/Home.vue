            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 d-flex flex-column justify-content-center order-2 order-lg-1">
                        ...
                        <p class="font-biryani text-secondary">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Commodi
                            debitis deserunt.</p>
                        ...
                        <div class="card border-0 shadow h-100 p-3">
                            <div class="card-body">
                                <div class="row my-3">
                                    <div class="col-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                             stroke="currentColor" height="44"
                                             class="bg-light text-spray p-2 rounded-circle">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
